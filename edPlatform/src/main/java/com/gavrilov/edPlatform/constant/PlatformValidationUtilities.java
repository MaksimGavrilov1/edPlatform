...
public class PlatformValidationUtilities {
    ...
    public static String NOT_EMPTY_COURSE_ALWAYS_OPEN = "Необходимо выбрать вариант ответа";
    public static String NOT_EMPTY_TAG_NAME = "Необходимо указать название тега, который будет добавлен в базу";
    ...
    public static String DUPLICATE_COURSE_TAGS = "Теги не должны повторяться";
    public static String DUPLICATE_TAG = "Данный тег уже существует";
    ...
    public static String FORBIDDEN_SYMBOL_TAG = "Тег не может содержать пробелы";
    ...
    public static String INCORRECT_TEST_ATTEMPTS_AMOUNT= "Количество попыток не должно быть менее 1 или более 5";
    public static String INCORRECT_TEST_MIN_THRESHOLD = "Минимальное количество правильных ответов не может быть больше количества вопросов";
    ...
    public static Integer MIN_TEST_ACTIVE_TIME = 1;
    ...
    public static Integer maxTagAmount;
